									...
									<?php if((int)$tool['vendor_id']){ ?>
			                        		...
			                        		<div>
			                            		<div class="radio status-radio">
					                            	<div class="row">
					                                	...
					                                	<div class="col-sm-3"><label><input type="radio" name="status" value="1" <?= (int)$tool['status'] == 1 ? 'checked' : '' ?> > <span class="badge badge-success"><?= __('admin.approved'); ?></span></label></div>
					                                	<div class="col-sm-3"><label><input type="radio" name="status" value="2" <?= (int)$tool['status'] == 2 ? 'checked' : '' ?> ><span class="badge badge-danger"><?= __('admin.denied'); ?></span></label></div>
					                                	<div class="col-sm-3"><label><input type="radio" name="status" value="3" <?= (int)$tool['status'] == 3 ? 'checked' : '' ?> ><span class="badge badge-yellow"><?= __('admin.ask_to_edit'); ?></span></label></div>
					                            	</div>
					                            </div>
					                        </div>   
					                    </div>
										...
										<div class="well">
											<div class="for-program-tool">
												...
												<div class="form-group">
													<label class="control-label">Other Affiliate Commission</label>
											...
											<div class="for-action-tool">
												<h6 class="mb-4 mt-0 text-monospace text-secondary">Action Commission Settings</h6>
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group">
												...
												<div class="form-group">
													<h6 class="mb-4 mt-0 text-monospace text-secondary">Other Affiliate Setting: 
														<?= ($tool['action_amount'] && (int)$tool['action_click']) ? c_format($tool['action_amount']) ." Per ". (int)$tool['action_click'] ." Clicks" : "Not Set" ?>
													</h6>
												</div>
											</div>

											<div class="for-general_click-tool">
												<h6 class="mb-4 mt-0 text-monospace text-secondary">General Click Commission Settings</h6>
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group">
												...
												<div class="form-group">
													<h6 class="mb-4 mt-0 text-monospace text-secondary">Other Affiliate Setting: 
														<?= ($tool['general_amount'] && (int)$tool['general_click']) ? c_format($tool['general_amount']) ." Per ". (int)$tool['general_click'] ." Clicks" : "Not Set" ?>
													</h6>
												</div>
											</div>
										</div>
									...
									<?php } else { ?>
										<div class="form-group">
			                        		...
			                        		<div>
			                            		<div class="radio status-radio">
					                            	<div class="row">
					                                	<div class="col-sm-3"><label><input type="radio" name="status" value="0" checked=""> <span class="badge badge-warning"><?= __('admin.disable'); ?></span></label> &nbsp;</div>
					                                	<div class="col-sm-3"><label><input type="radio" name="status" value="1" <?= (int)$tool['status'] == 1 ? 'checked' : '' ?> > <span class="badge badge-success"><?= __('admin.enable'); ?></span></label></div>
					                            	</div>
					                            </div>
					                        </div>   
					                    </div>
