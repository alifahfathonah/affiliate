		...
		<td class="text-center">
			...
			<div class="dropdown">
			  ...
			  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
			  	...
			  	<a  href="<?= base_url('integration/integration_tools_form/'. $tool['_type'] .'/' . $tool['id']) ?>" class="dropdown-item"><?php echo __('admin.edit') ?></a>
			

				<a href="javascript:void(0)" class="dropdown-item btn-show-code" data-id='<?= $tool['id'] ?>'>Code</a>
				<a href="<?= base_url('integration/integration_tools_duplicate/'. $tool['id']) ?>" class="dropdown-item"><?php echo __('admin.duplicate') ?></a>
			    <div class="dropdown-divider"></div>

				<a href="<?= base_url('integration/integration_tools_delete/'. $tool['id']) ?>" class="dropdown-item tool-remove-link"><?php echo __('admin.delete') ?></a>

			  </div>
			</div>
		</td>
		<td class="text-center"><?= $key+1 ?></td>
		<td class="text-center"><?= $tool['username'] ? $tool['username'] : 'Admin' ?></td>
		<td width="100px">
			<?= $tool['name'] ?>
			<div>
