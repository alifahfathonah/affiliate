                ...
                <?php foreach($data_list as $index => $product){ ?>
                    ...
                    <?php if(isset($product['is_form'])){ ?>
                        <tr class="<?= $display_class ?>">
                            ...
                            <td>
                                <span class="user-avatar" style="background-image:url('<?php echo resize('assets/images/share-icon.png' ,100,100) ?>')"></span>
                            </td>
                            <td>
                                <?= $product['title'] ?>
                                <div>
                    ...
                    <?php } else if(isset($product['is_product'])) { ?>
                        ...
                        <tr class="<?= $display_class ?>">
                            ...
                            <td>
                                <span class="user-avatar" style="background-image:url('<?php echo resize('assets/images/product/upload/thumb/'. $product['product_featured_image'] ,100,100) ?>')"></span>
                            </td>
                            <td>
                    ...
                    <?php } else{ ?>
                        <tr class="<?= $display_class ?>">
                            ...
                            <td>
                                <span class="user-avatar" style="background-image:url('<?php echo resize('assets/images/product/upload/thumb/'. $product['featured_image'],100,100,1) ?>')"></span>
                            </td>
                            <td>
                                <?= $product['name'] ?>
                                <div>
